...
namespace Project.WebUI.AppCode.Extensions
{
    public static partial class Extension
    {
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}Project.WebUI.AppCode.Extensions");
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}2Project.WebUI.AppCode.Extensions");
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}1Project.WebUI.AppCode.Extensions");
